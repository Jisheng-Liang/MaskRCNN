...
class MASK_RCNN(object):
    _defaults = {
        "model_path": 'model_data/epoch056_loss0.329_val_loss0.285.h5',
    ...
    #   检测图片
    #---------------------------------------------------#
    def detect_image(self, image, count):
        ...
        visualize.display_instances(count, image[0], r['rois'], r['masks'], r['class_ids'], 
                                    self.class_names, r['scores'])
        # visualize.draw_rois(count, image[0], img, r['rois'], r['rois'], r['masks'], r['class_ids'], 
        #                             self.class_names, limit=10)
